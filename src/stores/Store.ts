...
class Store {
  ...
  get blinds (): { smallBlind: number, bigBlind: number } {
    return {
  ...
  get mustGameBeRestarted (): boolean {
  ...
  performContinuingGameReset (): void {
  ...
  setCurrentPage (pageToShow: PageName): void {
  ...
  setPlayersCount (amountOfPlayers: number): void {
