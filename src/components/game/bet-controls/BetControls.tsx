  ...
  return (
    <div className='bet-controls-container noSelect'>
      ...
      <div className="peak-cards-btn-container">
        <div className='control-btn-container'>
          <div className="control-btn noSelect" id="peakCardsBtn" onMouseDown={handlePeakCards} onTouchStart={handlePeakCards} onMouseUp={handleUnpeakCards} onTouchEnd={handleUnpeakCards} onMouseLeave={handleUnpeakCards} >PEAK CARDS</div>
        </div>
      </div>
    </div>
  );
